...
//                    if (snapshot.hasChild("userName") && snapshot.hasChild("profilepic") && snapshot.hasChild("status")) {
...
//                        }
//                    } else {
//                        Toast.makeText(setting.this, "User data is incomplete", Toast.LENGTH_SHORT).show();
//                    }
//                }
            }
            @Override
